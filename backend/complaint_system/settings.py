...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure--=@llo6r=&3(nt!f+(@d#noumh$rg=z(c2r1+oz37s(q40qef@',
)
...
# Set DB_ENGINE=mysql (and the related DB_* env vars) to use MySQL instead.
...
# CORS - open for local development between Vite (5173) and Django (8000)
CORS_ALLOW_ALL_ORIGINS = os.environ.get('CORS_ALLOW_ALL', 'True') == 'True'

# --- Escalation timing (in hours) per priority level ---
ESCALATION_DEADLINES_HOURS = {
    'High': 24,
    'Medium': 72,
    'Low': 168,
}
